...
(function () {
	...
	// VRender.ENV.isIphone = document.body.hasAttribute("iphone"); // 此时 body 还未显示
	VRender.ENV.useRem = document.documentElement.hasAttribute("data-dpr");
	...
	var initWithREM = function () {
		...
		$(window).resize(function () {
			...
			html.attr("data-fs", baseFontSize);
	...
	$(function () {
		VRender.ENV.isIphone = document.body.hasAttribute("iphone");
	});
})();