...
(function (isFront) {
	...
	var UIRadiobox = isFront ? VRender.Component.Radiobox : require(__vrender__).UIRadiobox;
	...
	_Holder.render = function ($, target) {
		...
		var self = this;
		Utils.each(Utils.toArray(this.getData()), function (data, i) {
	...
	UIRadioGroup.create = function (options) {
		...
		return new UIRadioGroup(target, options, holder);
	};
