...
(function () {
	...
	_UITreeCombobox.getSelectedIndex = function () {
		return this.tree.getSelectedIndex();
	};

	_UITreeCombobox.setSelectedIndex = function (value) {
		this.tree.setSelectedIndex(value);
	};

	_UITreeCombobox.getSelectedKey = function () {
		return this.tree.getSelectedKey();
	};

	_UITreeCombobox.setSelectedKey = function (value) {
		this.tree.setSelectedKey(value);
	};

	_UITreeCombobox.getSelectedData = function () {
	...
	var treeItemClickHandler = function (e) {
		var indexs = this.setSelectedIndex(true);
		console.log(indexs);
	};
