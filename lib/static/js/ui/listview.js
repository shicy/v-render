...
(function () {
	...
	var _UIListView = UIListView.prototype = new Component.select();
	...
	UIListView.instance = function (target) {
		return Component.instance(target, ".ui-listview");
	};
