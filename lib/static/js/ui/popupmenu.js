...
(function () {
	...
	var tryLoadData = function (item) {
		...
		var self = this;
		doLoad.call(this, apiName, apiParams, function () {
	...
	var doLoad = function (api, params, callback) {
		var self = this;
		...
		setTimeout(function () {
			var container = self.$el.children().last();
			var loadingItem = $("<li class='loading'></li>").appendTo(container.children(".menus"));
