...
(function () {
	...
	ComponentSelect.isSelected = function (data, index, selectedIndexs, selectedIds) {
		return Renderer.fn.isSelected.call(this, data, index, selectedIndexs, selectedIds);
	};
