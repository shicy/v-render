...
(function () {
	...
	_ComponentBase.setData = function (value) {
		...
		this._dataChanged(this.options.data);
	};
	...
	// ====================================================
	// 数据变更的时候调用方法
	_ComponentBase._dataChanged = function (data) {
		// 子类需继承
	};
	...
	_ComponentList.addOrUpdateItem = function (data, index) {

	};

	_ComponentList.getItemIndex = function (target) {

	};

	// ====================================================
	_ComponentList._renderItems = function (itemContainer) {

	};

	_ComponentList._renderOneItem = function (item, container, data, index, bSelected) {
