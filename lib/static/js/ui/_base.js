...
(function () {
	...
	ComponentBase.doAdapter = function (data) {
		return VRender.Component.Render.fn.doAdapter.call(this, data);
	};
	...
	_ComponentBase.getDataId = function (data) {
		return Component.VRender.Render.fn.getDataId.call(this, data);
	};

	_ComponentBase.getDataLabel = function (data, index) {
		return Component.VRender.Render.fn.getDataLabel.call(this, data, index);
	};

	_ComponentBase.getMapData = function (data, index) {
		return Component.VRender.Render.fn.getMapData.call(this, data, index);
	};
	...
	ComponentList.getIntValues = function (value, min, max) {
		...
		min = Utils.isNull(min) ? Number.MIN_VALUE : min;
		max = Utils.isNull(max) ? Number.MAX_VALUE : max;
		var values = [];
	...
	_ComponentList.getData = function () {
		return ComponentBase.doAdapter.call(this, Utils.toArray(this.options.data));
	};
	...
	_ComponentList.getSelectedIndex = function (needArray) {
		...
		return selectedIndex.length > 0 ? selectedIndex[0] : -1;
	};
