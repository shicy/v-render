...
(function (isFront) {
	...
	var Holder = function (options) {
		...
		if (this.options.hasOwnProperty("selectedIndex"))
			this.setSelectedIndexs(this.options.selectedIndex);
		if (this.options.hasOwnProperty("selectedIndexs"))
			this.setSelectedIndexs(this.options.selectedIndexs);
		if (this.options.hasOwnProperty("selectedId"))
			this.setSelectedIds(this.options.selectedId);
		if (this.options.hasOwnProperty("selectedIds"))
			this.setSelectedIds(this.options.selectedIds);
	...
	var UIDatagrid = Component.Datagrid = function (view, options) {
		...
		var self = this;
		this.$el.tap(".row-item", function (e) { return itemClickHandler.call(self, e); });
		this.$el.tap(".chkbox", function (e) { return chkboxClickHandler.call(self, e); });
		this.$el.tap("td.col-op > a", function (e) { return operatorHandler.call(self, e); });
	};
	...
	_UIDatagrid.getSelectedIndexs = function () {
		var indexs = [];
	...
	_UIDatagrid.setSelectedIndexs = function (value, trigger) {
	...
	var getFunction = function (name, type) {
		...
		if (this.hasOwnProperty(name))
			return this[name];
		var target = this.$el.children(".ui-fn[name='" + type +"']").text();
		if (func) {
