...
(function () {
	...
	_UIDatagrid.setExpandRenderer = function (value) {
		...
		if (_changed) {
			var itemContainer = this._getItemContainer();
			itemContainer.find(".row-expand").remove();
			var expandRows = itemContainer.find(".expand").removeClass("expand");
	...
	var updateEnumFilters = function () {
		var self = this;
	...
	var getHeaders = function () {
		return this.header.children("table").children("thead").children("tr").children("th");
	};
