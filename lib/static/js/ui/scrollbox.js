...
(function () {
	...
	UIScrollBox.instance = function (target) {
		return Component.instance(target, ".ui-scrollbox");
	};
	...
	_UIScrollBox.getContentView = function () {
		if (!this.contentView) {
			...
			if (content && content.length > 0) {
				if (content.length === 1)
					this.contentView = Component.get(content);
				if (!this.contentView)
	...
	_UIScrollBox.getRefreshFunction = function () {
		return Renderer.fn.getFunction.call(this, "refreshFunction", "refresh");
	};
	...
	_UIScrollBox.getMoreFunction = function () {
		return Renderer.fn.getFunction.call(this, "moreFunction", "more");
	};
