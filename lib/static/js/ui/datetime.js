...
(function () {
	...
	var pickerScrollHandler = function (e) {
		...
		setDateInner.call(this, getPickerDate.call(this, this.picker));
	};
	...
	var getPickerDate = function (picker) {
		if (this.isRenderAsApp()) {
			...
			var month = parseInt(target.children(".month").find(".selected").text()) || 0;
			var day = parseInt(target.children(".day").find(".selected").text()) || 0;
