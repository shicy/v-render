...
(function (backend) {
	...
	_BaseRenderer.renderData = function ($, target) {
		BaseRenderer.renderData.call(this, $, target, this.getData());
	};
	...
	_BaseRenderer._getDataId = function () {
		return this.getDataId.apply(this, Array.prototype.slice.call(arguments));
	};
	...
	_BaseRenderer._getDataLabel = function () {
		return this.getDataLabel.apply(this, Array.prototype.slice.call(arguments));
	};
	...
	_BaseRenderer._doAdapter = function () {
		return this.doAdapter.apply(this, Array.prototype.slice.call(arguments));
	};
	...
	_ListRenderer._renderItems = function () {
		this.renderItems.apply(this, Array.prototype.slice.call(arguments));
	};
	...
	_ListRenderer._renderOneItem = function () {
		this.renderOneItem.apply(this, Array.prototype.slice.call(arguments));
	};
	...
	_ListRenderer.renderData = function ($, target) {
		if (backend) {
			var self = this;
			var datas = Utils.map(this.getData(), function (data) {
	...
	_ListRenderer._getItemContainer = function () {
		return this.getItemContainer.apply(this, Array.prototype.slice.call(arguments));
	};
	...
	_ListRenderer._getNewItem = function () {
		return this.getNewItem.apply(this, Array.prototype.slice.call(arguments));
	};
	...
	_ListRenderer._isSelected = function () {
		return this.isSelected.apply(this, Array.prototype.slice.call(arguments));
	};
	...
	_ListRenderer.isAllSelected = function () {
		...
		for (var i = 0, l = datas.length; i < l; i++) {
			if (!this._isSelected(data, i, datas[i], i, selectedIndex, selectedId))
				return false;
		}
		return datas.length > 0;
	};

	_ListRenderer.doAdapter = function (data, index) {
