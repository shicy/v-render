...
var FILE_EXTS = [".fe.js", ".front.js", ".css", ".p.css", ".m.css", ".less", ".p.less", ".m.less", ".scss", ".p.scss", ".m.scss"];
var FILE_EXTS_SCRIPT = [".fe.js", ".front.js"];
var FILE_EXTS_STYLE = [".css", ".p.css", ".m.css", ".less", ".p.less", ".m.less", ".scss", ".p.scss", ".m.scss"];
...
var doClassImport = function (imports, ViewClass, pushOnly) {
	...
	if (ViewClass.__module__) {
		...
		Utils.each(FILE_EXTS, function (ext) {
...
var getImportFiles = function (type, isApp) {
	...
	// ArrayUtils.each(_imports, function (data) {
	// 	var filename = data.path.split("?")[0].toLowerCase();
	// 	if (StringUtils.endWith(filename, type)) {
	// 		if (isApp) {
	// 			if (StringUtils.endWith(filename, ".p" + type))
	// 				return ;
	// 		}
	// 		else if (StringUtils.endWith(filename, ".m" + type))
	// 			return ;
