...
var UIDatagrid = _UISelect.extend(module, {
	doInit: function () {
		...
		this.renderer = new DatagridRender(this, this.options);
	},
	...
	isHeaderVisible: function () {
		return this.renderer.isHeaderVisible();
	},
	...
	getExpandCols: function () {
		return parseInt(this.options.extendcols);
	},
	setExpandCols: function (value) {
		this.options.extendcols = value;
	},
