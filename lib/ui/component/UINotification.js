...
var NotificationRender = require("../../static/js/render/notification");


var UINotification = UIView.extend(module, {
	...
	renderView: function () {
		UINotification.__super__.renderView.call(this);
		var renderer = new NotificationRender(this, this.options);
