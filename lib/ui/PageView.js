...
var PageView = View.extend(module, {
	...
	doFileImport: function () {
		...
		if (this._isRenderAsApp) {
			this.import("/VRender.front.mobile.min.css?v=1712181114", {group: false, index: -1});
			this.import("/VRender.front.mobile.min.js?v=1712181114", {group: false, index: -1});
		}
		else {
			this.import("/VRender.front.min.css?v=1712181114", {group: false, index: -1});
			this.import("/VRender.front.min.js?v=1712181114", {group: false, index: -1});
		}
	},
