...
var PageView = View.extend(module, {
	doInit: function (done) {
		PageView.super(this, (function () {
			...
			this.doFileImport();
			PluginManager.initPageView.call(this);
	...
	doFileImport: function () {
		if (this.getContext().config("babel")) {
			// this.import("https://cdn.polyfill.io/v3/polyfill.min.js", {group: false, index: -2});
			this.import("/VRender/babel/polyfill.js?v=190409", {group: "core", minify: false, index: -2, b: "yy"});
		}
		this.import("/VRender.core.js?v=190409", {group: "core", minify: false, index: -1, a: "ok"});
		if (this._isRenderAsApp) {
			// this.import("/VRender.front.mobile.min.css?v=190515", {group: "core", minify: false, index: -1});
			this.import("/VRender.front.mobile.min.js?v=190515", {group: "core", minify: false, index: -1});
		}
		else {
			// this.import("/VRender.front.min.css?v=190515", {group: "core", minify: false, index: -1});
			this.import("/VRender.front.min.js?v=190515", {group: "core", minify: false, index: -1});
		}
	},
