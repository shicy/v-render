	...
	doFileImport: function () {
		...
		if (this.userState) {
			if (this.userState.isMobile) {
				this.import("/VRender.front.mobile.min.css?v=1701312210", {group: false, index: -1});
				this.import("/VRender.front.mobile.min.js?v=1701312210", {group: false, index: -1});
			}
			else {
				this.import("/VRender.front.min.css?v=1701312210", {group: false, index: -1});
				this.import("/VRender.front.min.js?v=1701312210", {group: false, index: -1});
			}
		}
	},
