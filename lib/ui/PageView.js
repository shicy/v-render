	...
	doFileImport: function () {
		...
		if (this.userState) {
			if (this.userState.isMobile) {
				this.import("/VRender.front.mobile.min.css?v=1611071647", {group: false});
				this.import("/VRender.front.mobile.min.js?v=1611071647", {group: false});
			}
			else {
				this.import("/VRender.front.min.css?v=1611071647", {group: false});
				this.import("/VRender.front.min.js?v=1611071647", {group: false});
			}
		}
	},
