...
var PageView = View.extend(module, {
	...
	doFileImport: function () {
		if (this.getContext().config("babel")) {
			...
			this.import("/VRender/babel/polyfill.js?v=190409", {group: false, index: -2});
		}
		this.import("/VRender.core.js?v=190409", {group: false, index: -1});
		if (this._isRenderAsApp) {
			this.import("/VRender.front.mobile.min.css?v=190515", {group: false, index: -1});
			this.import("/VRender.front.mobile.min.js?v=190515", {group: false, index: -1});
		}
		else {
			this.import("/VRender.front.min.css?v=190515", {group: false, index: -1});
			this.import("/VRender.front.min.js?v=190515", {group: false, index: -1});
		}
	},
