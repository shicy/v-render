...
///////////////////////////////////////////////////////////
var VRender = module.exports = function (options) {
	if (!(this instanceof VRender))
		throw new Error("请使用 new 创建实例！！");
...
VRender.UIConfirm         = require("./ui/component/UIConfirm");
...
VRender.UIDateTime        = require("./ui/component/UIDateTime");
...
VRender.UITimeInput       = require("./ui/component/UITimeInput");
VRender.UITooltip         = require("./ui/component/UITooltip");
VRender.UITreeView        = require("./ui/component/UITreeView");
VRender.UITreeCombobox    = require("./ui/component/UITreeCombobox");
...
var initLog4jConfigs = function (config) {
