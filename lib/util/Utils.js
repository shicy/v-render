...
// 
Utils.nextTick = _Utils.nextTick;
...
Utils._public = {
	...
	mkdirsSync: FileUtils.mkdirsSync,
	rmdirSync: FileUtils.rmdirSync,
	getModuleFilePath: FileUtils.getModuleFilePath
};
