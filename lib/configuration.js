...
var Configs = module.exports = {
	...
	// 前端脚本和样式合并压缩文件的有效期限，单位毫秒，默认永不失效
	...
	// 将会被代理的域名，这里配置的域名在请求时，header会被替换成真实域名
	// proxyHosts: [],
	...
	dataServer: {
		...
		// 发起请求的内容类型，默认为 “application/x-www-form-urlencoded;charset=UTF-8”
		// contentType: "",
