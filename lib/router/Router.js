...
var apiRouterHandler = function (session, apiName, apiParams, version, callback) {
	...
	if (router && Utils.isFunction(router.handler)) {
		var scope = newScope(session, {api: apiName, params: apiParams, version: version});
...
var doViewMap = function (pathname, params, callback) {
	...
	if (router && Utils.isFunction(router.handler)) {
		var scope = newScope(params.params.session, {pathname: pathname, params: viewParams});
...
var newScope = function (session, data) {
	var scope = data || {};
